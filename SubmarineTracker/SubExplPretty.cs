...
public static class SubmarineExplorationExtensions
{
    ...
    private static uint GetSurveyTime(this SubmarineExploration sheet, float speed)
    {
        if (speed < 1)
            speed = 1;
    ...
    private static uint GetVoyageTime(this SubmarineExploration sheet, SubmarineExploration otherSheet, float speed)
    {
        if (speed < 1)
            speed = 1;
